...
class ARMANonSignificantGenerator(ARMAGenerator):
    ...
    be lower than 0.1 to make them 'non-significant'.
    ...
    def _are_params_valid(self, params: np.ndarray, order: List[int]) -> bool:
        ...
        coefficient are both smaller than 0.1 in absolute terms, i.e., they
        cause "non-significant" AR and MA behavior in their last coefficient.
